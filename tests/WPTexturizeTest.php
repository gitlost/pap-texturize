...
class Tests_Formatting_PAP_WPTexturize extends WP_UnitTestCase {
	...
	function test_bracketed_quotes_3810() {
		$this->assertEquals('A dog (&#8220;Hubertus&#8221;) was sent out.', pap_wptexturize('A dog ("Hubertus") was sent out.'));
	}

	/**
	 * #ticket 4539 // Tickets marked with # to avoid skipping due to not fixed in trac.
	 */
	function test_basic_quotes() {
		$this->assertEquals('test&#8217;s', pap_wptexturize('test\'s'));

		$this->assertEquals('&#8216;quoted&#8217;', pap_wptexturize('\'quoted\''));
		$this->assertEquals('&#8220;quoted&#8221;', pap_wptexturize('"quoted"'));

		$this->assertEquals('space before &#8216;quoted&#8217; space after', pap_wptexturize('space before \'quoted\' space after'));
		$this->assertEquals('space before &#8220;quoted&#8221; space after', pap_wptexturize('space before "quoted" space after'));

		$this->assertEquals('(&#8216;quoted&#8217;)', pap_wptexturize('(\'quoted\')'));
		$this->assertEquals('{&#8220;quoted&#8221;}', pap_wptexturize('{"quoted"}'));

		$this->assertEquals('&#8216;qu(ot)ed&#8217;', pap_wptexturize('\'qu(ot)ed\''));
		$this->assertEquals('&#8220;qu{ot}ed&#8221;', pap_wptexturize('"qu{ot}ed"'));

		$this->assertEquals(' &#8216;test&#8217;s quoted&#8217; ', pap_wptexturize(' \'test\'s quoted\' '));
		$this->assertEquals(' &#8220;test&#8217;s quoted&#8221; ', pap_wptexturize(' "test\'s quoted" '));
	}
	...
	function test_full_sentences_with_unmatched_single_quotes() {
		$this->assertEquals(
			...
			pap_wptexturize("That means every moment you're working on something without it being in the public it's actually dying.")
		);
	}
	...
	function test_quotes() {
		$this->assertEquals('&#8220;Quoted String&#8221;', pap_wptexturize('"Quoted String"'));
		$this->assertEquals('Here is &#8220;<a href="http://example.com">a test with a link</a>&#8221;', pap_wptexturize('Here is "<a href="http://example.com">a test with a link</a>"'));
		$this->assertEquals('Here is &#8220;<a href="http://example.com">a test with a link and a period</a>&#8221;.', pap_wptexturize('Here is "<a href="http://example.com">a test with a link and a period</a>".'));
		$this->assertEquals('Here is &#8220;<a href="http://example.com">a test with a link</a>&#8221; and a space.', pap_wptexturize('Here is "<a href="http://example.com">a test with a link</a>" and a space.'));
		$this->assertEquals('Here is &#8220;<a href="http://example.com">a test with a link</a> and some text quoted&#8221;', pap_wptexturize('Here is "<a href="http://example.com">a test with a link</a> and some text quoted"'));
		$this->assertEquals('Here is &#8220;<a href="http://example.com">a test with a link</a>&#8221;, and a comma.', pap_wptexturize('Here is "<a href="http://example.com">a test with a link</a>", and a comma.'));
		$this->assertEquals('Here is &#8220;<a href="http://example.com">a test with a link</a>&#8221;; and a semi-colon.', pap_wptexturize('Here is "<a href="http://example.com">a test with a link</a>"; and a semi-colon.'));
		$this->assertEquals('Here is &#8220;<a href="http://example.com">a test with a link</a>&#8221;- and a dash.', pap_wptexturize('Here is "<a href="http://example.com">a test with a link</a>"- and a dash.'));
		$this->assertEquals('Here is &#8220;<a href="http://example.com">a test with a link</a>&#8221;&#8230; and ellipses.', pap_wptexturize('Here is "<a href="http://example.com">a test with a link</a>"... and ellipses.'));
		$this->assertEquals('Here is &#8220;a test <a href="http://example.com">with a link</a>&#8221;.', pap_wptexturize('Here is "a test <a href="http://example.com">with a link</a>".'));
		$this->assertEquals('Here is &#8220;<a href="http://example.com">a test with a link</a>&#8221;and a work stuck to the end.', pap_wptexturize('Here is "<a href="http://example.com">a test with a link</a>"and a work stuck to the end.'));
		$this->assertEquals('A test with a finishing number, &#8220;like 23&#8221;.', pap_wptexturize('A test with a finishing number, "like 23".'));
		$this->assertEquals('A test with a number, &#8220;like 62&#8221;, is nice to have.', pap_wptexturize('A test with a number, "like 62", is nice to have.'));
	}
	...
	function test_quotes_before_s() {
		...
		$this->assertEquals('&#8216;test&#8217;s', pap_wptexturize("'test's"));
		$this->assertEquals('&#8216;test&#8217;s&#8217;', pap_wptexturize("'test's'"));
		$this->assertEquals('&#8216;string&#8217;', pap_wptexturize("'string'"));
		$this->assertEquals('&#8216;string&#8217;s&#8217;', pap_wptexturize("'string's'"));
	}
	...
	function test_quotes_before_numbers() {
		$this->assertEquals('Class of &#8217;99', pap_wptexturize("Class of '99"));
		$this->assertEquals('Class of &#8217;99&#8217;s', pap_wptexturize("Class of '99's"));
		$this->assertEquals('&#8216;Class of &#8217;99&#8217;', pap_wptexturize("'Class of '99'"));
		$this->assertEquals('&#8216;Class of &#8217;99&#8217; ', pap_wptexturize("'Class of '99' "));
		$this->assertEquals('&#8216;Class of &#8217;99&#8217;.', pap_wptexturize("'Class of '99'."));
		$this->assertEquals('&#8216;Class of &#8217;99&#8217;, she said', pap_wptexturize("'Class of '99', she said"));
		$this->assertEquals('&#8216;Class of &#8217;99&#8217;:', pap_wptexturize("'Class of '99':"));
		$this->assertEquals('&#8216;Class of &#8217;99&#8217;;', pap_wptexturize("'Class of '99';"));
		$this->assertEquals('&#8216;Class of &#8217;99&#8217;!', pap_wptexturize("'Class of '99'!"));
		$this->assertEquals('&#8216;Class of &#8217;99&#8217;?', pap_wptexturize("'Class of '99'?"));
		...
		$this->assertEquals(' &#8220;Class of &#8217;99&#8221;!', pap_wptexturize(" \"Class of '99\"!"));
		$this->assertEquals(' &#8220;Class of &#8217;99&#8221;?', pap_wptexturize(" \"Class of '99\"?"));
		$this->assertEquals('}&#8221;Class of &#8217;99&#8243;{', pap_wptexturize("}\"Class of '99\"{")); // Not a quotation, may be between two other quotations.
	}
	...
	function test_other_html() {
		$this->assertEquals('&#8216;<strong>', pap_wptexturize("'<strong>"));
		$this->assertEquals('&#8216;<strong>Quoted Text</strong>&#8217;,', pap_wptexturize("'<strong>Quoted Text</strong>',"));
		$this->assertEquals('&#8220;<strong>Quoted Text</strong>&#8221;,', pap_wptexturize('"<strong>Quoted Text</strong>",'));
	}

	function test_x() {
		$this->assertEquals('14&#215;24', pap_wptexturize("14x24"));
	}

	function test_minutes_seconds() {
		$this->assertEquals('9&#8242;', pap_wptexturize('9\''));
		$this->assertEquals('9&#8243;', pap_wptexturize("9\""));

		$this->assertEquals('a 9&#8242; b', pap_wptexturize('a 9\' b'));
		$this->assertEquals('a 9&#8243; b', pap_wptexturize("a 9\" b"));
	...
	function test_wptexturize_quotes_around_numbers() {
		$this->assertEquals('&#8220;12345&#8221;', pap_wptexturize('"12345"'));
		$this->assertEquals('&#8216;12345&#8217;', pap_wptexturize('\'12345\''));
		$this->assertEquals('&#8220;a 9&#8242; plus a &#8216;9&#8217;, maybe a 9&#8242; &#8216;9&#8217;&#8221;', pap_wptexturize('"a 9\' plus a \'9\', maybe a 9\' \'9\'"'));
		$this->assertEquals('<p>&#8217;99<br />&#8216;123&#8217;<br />&#8217;tis<br />&#8216;s&#8217;</p>', pap_wptexturize('<p>\'99<br />\'123\'<br />\'tis<br />\'s\'</p>'));
	}
	...
	function test_wptexturize_html_comments() {
		$this->assertEquals('<!--[if !IE]>--><!--<![endif]-->', pap_wptexturize('<!--[if !IE]>--><!--<![endif]-->'));
		$this->assertEquals('<!--[if !IE]>"a 9\' plus a \'9\', maybe a 9\' \'9\' "<![endif]-->', pap_wptexturize('<!--[if !IE]>"a 9\' plus a \'9\', maybe a 9\' \'9\' "<![endif]-->'));
		$this->assertEquals('<ul><li>Hello.</li><!--<li>Goodbye.</li>--></ul>', pap_wptexturize('<ul><li>Hello.</li><!--<li>Goodbye.</li>--></ul>'));
	}
	...
	function test_entity_quote_cuddling() {
		$this->assertEquals('&nbsp;&#8220;Testing&#8221;', pap_wptexturize('&nbsp;"Testing"'));
		//$this->assertEquals('&#38;&#8220;Testing&#8221;', pap_wptexturize('&#38;"Testing"'));
	}
	...
	function test_apostrophes_before_primes() {
		$this->assertEquals( 'WordPress 3.5&#8217;s release date', pap_wptexturize( "WordPress 3.5's release date" ) );
	}
	...
	function test_spaces_around_hyphens() {
		...
		$this->assertEquals( ' &#8211; ', pap_wptexturize( ' - ' ) );
		$this->assertEquals( '&nbsp;&#8211;&nbsp;', pap_wptexturize( '&nbsp;-&nbsp;' ) );
		$this->assertEquals( ' &#8211;&nbsp;', pap_wptexturize( ' -&nbsp;' ) );
		$this->assertEquals( '&nbsp;&#8211; ', pap_wptexturize( '&nbsp;- ') );
		$this->assertEquals( "$nbsp&#8211;$nbsp", pap_wptexturize( "$nbsp-$nbsp" ) );
		$this->assertEquals( " &#8211;$nbsp", pap_wptexturize( " -$nbsp" ) );
		$this->assertEquals( "$nbsp&#8211; ", pap_wptexturize( "$nbsp- ") );
	...
	function test_spaces_around_quotes_never() {
		...
		$this->assertNotEquals( $problem_output, pap_wptexturize( $problem_input ) );
	}
	...
	function test_spaces_around_quotes( $input, $output ) {
		return $this->assertEquals( $output, pap_wptexturize( $input ) );
	}
	 ...
	 *
	 * Checks all baseline patterns. If anything ever changes in pap_wptexturize(), these tests may fail.
	 *
	 * @ticket 22692
	...
	function data_opening_single_quote() {
		return array(
			...
			array(
				"word\"' word word",
				"word&#8221;&#8217; word word", // Incompatibility: was closing quote, then opening quote - now: two closing quotes.
			),
		);
	}
	...
	function test_unregistered_shortcodes( $input, $output ) {
		...
		$output = $this->assertEquals( $output, pap_wptexturize( $input ) );
...
String with a number followed by a single quote !q1!Expendables 3!q1! vestibulum in arcu mi.',
	...
	function test_trailing_less_than() {
		$this->assertEquals( 'F&#8211;oo<', pap_wptexturize( 'F--oo<', true ) );
	}

	function data_whole_posts() {
		//require_once( DIR_TESTDATA . '/formatting/whole-posts.php' );
		require_once( 'data' . '/formatting/whole-posts.php' );
	...
	/**
	 * Test low-level pap_wptexturize_replace_xxx routines.
	 * @ticket pap_wptexturize_replace_xxx
	 */
	 ...
	 *
	 * #ticket 29882
	 * @dataProvider test_nested_quotations_data
	 */
	function test_nested_quotations( $input, $output ) {
		return $this->assertEquals( $output, pap_wptexturize( $input ) );
	}

	function test_nested_quotations_data() {
		$so = '&#8216;';
		$sc = $apos = '&#8217;';
		$do = '&#8220;';
		$dc = '&#8221;';
		...
		return array(
			array( "She said, \"'I'm tired,' he mumbled.\"", "She said, {$do}{$so}I{$apos}m tired,{$sc} he mumbled.{$dc}" ),
			array( "She said, \"He mumbled, 'I'm tired.'\"", "She said, {$do}He mumbled, {$so}I{$apos}m tired.{$sc}{$dc}" ),
			array( "He said, '\"I'm tired,\" she mumbled.'", "He said, {$so}{$do}I{$apos}m tired,{$dc} she mumbled.{$sc}" ),
			array( "He said, 'She mumbled, \"I'm tired.\"'", "He said, {$so}She mumbled, {$do}I{$apos}m tired.{$dc}{$sc}" ),

			array( "She said, \"'I'm tired', he mumbled\".", "She said, {$do}{$so}I{$apos}m tired{$sc}, he mumbled{$dc}." ), // Punctuation outside quotes.
			array( "She said, \"He mumbled, 'I'm tired'\".", "She said, {$do}He mumbled, {$so}I{$apos}m tired{$sc}{$dc}." ),
			array( "He said, '\"I'm tired\", she mumbled'.", "He said, {$so}{$do}I{$apos}m tired{$dc}, she mumbled{$sc}." ),
			array( "He said, 'She mumbled, \"I'm tired\"'.", "He said, {$so}She mumbled, {$do}I{$apos}m tired{$dc}{$sc}." ),

			array( "She said, \"'99', he mumbled.\"", "She said, {$do}{$so}99{$sc}, he mumbled.{$dc}" ),
			array( "He said, '\"99\", she mumbled.'", "He said, {$so}{$do}99{$dc}, she mumbled.{$sc}" ),
		);
	}
}
